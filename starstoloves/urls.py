...
urlpatterns = patterns('',
    ...
    url(r'^disconnect-lastfm/$',    connection.disconnect_lastfm, name='disconnect_lastfm'),
    url(r'^disconnect-spotify/$',   connection.disconnect_spotify, name='disconnect_spotify'),
